package com.megabyte512.tennis.item;
...
public class TennisItems implements ModInitializer {
  ...
  public static Item NETHERITE_RACKET;
    ...
    // Register tennis ball, not a tool that can be init like rackets
    ...
    TENNIS_BALL = Registry.register(Registries.ITEM, ballKey, new Item(new Item.Settings().maxCount(1).registryKey(ballKey)));
		...
		LOGGER.info("Tennis items initialized!");
	}
